...
var uitvouwIframe = document.getElementById('uitvouwIframe')
var videoInfo = document.getElementById('videoInfo')
var closeButton = document.getElementById('close')
var iframe = document.getElementById('iframe')

uitvouwIframe.addEventListener('click', function(){
  if (videoInfo.getAttribute('Style') !== 'transform: translateX(0%);') {
    videoInfo.setAttribute('Style', 'transform: translateX(0%);')
    closeButton.setAttribute('Style', 'transform: translateX(-420%);')
    iframe.setAttribute('Style', 'transform: translateX(0%);')
    uitvouwIframe.setAttribute('Style', 'transform: rotate(225deg);')
  } else {
    videoInfo.setAttribute('Style', 'transform: translateX(84%);')
    closeButton.setAttribute('Style', 'transform: translateX(-198%);')
    iframe.setAttribute('Style', 'transform: translateX(16%);')
    uitvouwIframe.setAttribute('Style', 'transform: rotate(45deg);')
  }
})
